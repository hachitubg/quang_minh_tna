            ...
            <div className="container">
                {
                    ...
                    <div className="section-title-area">
                        <SectionTitle>
                            <SectionTitle.SubTitle>Đội ngũ & dịch vụ</SectionTitle.SubTitle>
                            <SectionTitle.Title>Đội ngũ chuyên gia hỗ trợ</SectionTitle.Title>
                        </SectionTitle>
                        <Link to="/ho-tro-khach-hang" className="theme-btn wow slideUp" data-delay=".5">
                            Liên hệ hỗ trợ
                        ...
                        >
                            <div className="team-card-items">
                                ...
                                <div className="team-content text-center">
                                    <h3>
                                        <Link to="/ho-tro-khach-hang">{member.name}</Link>
                                    </h3>
                                    <p>{member.role}</p>
                                </div>
                            </div>
